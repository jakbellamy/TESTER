...
//    VALIDATE
  VALIDATE(answrKey)
//    BUILD TEST OBJECT WITH TEST FUNCTION AND PAYLOAD (ANSWRKEY)
  let test = {
    function:
      function test(answrKey, testData){
        VALIDATE(testData);
        const key = answrKey
...
test.function(test.payload, [{in: 'test', out: 'grfg'}, {in: 'sdafsfd', out: 'asdfasd'}]);
